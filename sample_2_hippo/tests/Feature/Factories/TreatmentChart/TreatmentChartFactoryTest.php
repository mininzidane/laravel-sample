...
namespace Tests\Feature\Factories\TreatmentChart;

use App\Models\TreatmentChart;
use Tests\Helpers\PassportSetupTestCase;
use Tests\Helpers\TruncateDatabase;

class TreatmentChartFactoryTest extends PassportSetupTestCase
{
	use TruncateDatabase;

	public function test_factory_can_create_data()
	{
		/** @var TreatmentChart $model */
		$model = TreatmentChart::factory()->create();
