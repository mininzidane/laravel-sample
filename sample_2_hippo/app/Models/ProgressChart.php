 ...
 */
class ProgressChart extends HippoChart
{
	use HasFactory;

	public static $graphQLType = ProgressChartGraphQLType::class;

	protected $table = "tblChartProgress";

	protected $chartType = "progress";
