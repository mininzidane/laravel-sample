...
class MucousMembraneStatusUpdateMutation extends AppHippoMutation
{
	protected $model = MucousMembraneStatus::class;

	protected $permissionName = "Mucous Membrane Statuses: Update";

	protected $attributes = [
		"name" => "MucousMembraneStatusUpdate",
		"model" => MucousMembraneStatus::class,
	];

	protected $actionId = HippoGraphQLActionCodes::MUCOUSMEMBRANESTATUS_UPDATE;
	...
	public function args(): array
	{
		return [
			...
			"input" => [
				"type" => GraphQL::type("MucousMembraneStatusUpdateInput"),
			],
		];
	}
