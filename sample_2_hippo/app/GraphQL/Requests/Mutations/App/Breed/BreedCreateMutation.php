...
class BreedCreateMutation extends AppHippoMutation
{
	protected $model = Breed::class;

	protected $permissionName = "Breeds: Create";
	...
	protected $actionId = HippoGraphQLActionCodes::BREED_CREATE;
	...
	public function args(): array
	{
		return [
			"input" => [
				"type" => GraphQL::type("BreedCreateInput"),
			],
		];
	}
	...
	public function resolveTransaction(
		...
		$breed = $modelInstance->withTrashed()->updateOrCreate(
			[
