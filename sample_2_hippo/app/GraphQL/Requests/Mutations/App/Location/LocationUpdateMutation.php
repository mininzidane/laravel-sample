...
class LocationUpdateMutation extends LocationMutation
{
	protected $model = Location::class;

	protected $permissionName = "Locations: Update";
	...
	public function resolveTransaction(
		...
		if (!$modelInstance) {
			throw new Exception(
				"Cannot update non-existient location: " . $args["id"],
			);
		}
		...
		$this->updateLocationEmail($modelInstance->email);

		$modelInstance->fill($this->args["input"]);
